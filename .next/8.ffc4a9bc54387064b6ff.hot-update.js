...
/* WEBPACK VAR INJECTION */(function(module) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__components_loader__ = __webpack_require__("./components/loader/index.js");
...
function (_Component) {
  ...
  _createClass(Dashboard, [{
    ...
    value: function componentDidMount() {
      ...
      if (Object(__WEBPACK_IMPORTED_MODULE_4__utils_cookies__["a" /* getCookies */])('PDCLOGID')) {
        __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get('http://localhost:4000/program').then(function (res) {
          if (res.data) _this2.setState({
            program: res.data
          });
        });
        var catchLog = JSON.parse(decodeURIComponent(Object(__WEBPACK_IMPORTED_MODULE_4__utils_cookies__["a" /* getCookies */])('PDCLOGID')));
        __WEBPACK_IMPORTED_MODULE_3_axios___default.a.get("http://localhost:4000/user/".concat(catchLog.u)).then(function (res) {
          if (res.data) _this2.setState({
            user: res.data,
            isLoading: false
          });
    ...
    value: function startQuestion(progId) {
      Object(__WEBPACK_IMPORTED_MODULE_4__utils_cookies__["c" /* setCookies */])('PROG-ID', progId);
    ...
    value: function render() {
      ...
      if (isLoading) {
        return __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_0__components_loader__["a" /* default */], {
          __source: {
        ...
        return __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("div", {
        ...
        }, __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__components_header__["a" /* default */], {
          user: user,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 49
        ...
        }, __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_2__components_nav__["a" /* default */], {
          user: user,
          __source: {
            fileName: _jsxFileName,
            lineNumber: 53
        ...
        }, "Dashboard")), __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("div", {
        ...
        }, __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("li", {
          ...
          }, program.program_name), __WEBPACK_IMPORTED_MODULE_5_react___default.a.createElement("h6", {
            __source: {
              fileName: _jsxFileName,
              lineNumber: 91
            }
...
//# sourceMappingURL=8.ffc4a9bc54387064b6ff.hot-update.js.map