...
function (_Component) {
  ...
  _createClass(Start, [{
    ...
    value: function componentDidMount() {// if(getCookies('PDCLOGID')) {
        ...
        Object(__WEBPACK_IMPORTED_MODULE_7__utils_image_upload__["a" /* imageUpload */])(img).then(function (res) {
          if (res.data.data) {
            __WEBPACK_IMPORTED_MODULE_5_axios___default.a.post("http://localhost:4000/add_photo", {
              applicant_id: _this2.state.user.applicant_id,
              client_id: _this2.state.user.client_id,
              login_time: _this2.logCookie.t,
...
//# sourceMappingURL=5.225c019842025c3b947d.hot-update.js.map